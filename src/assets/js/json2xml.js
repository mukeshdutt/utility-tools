// ========================================================================
//  XMLObjTree -- XML source code from/to JavaScript object like E4X
// ========================================================================
...
XMLObjTree.VERSION = "0.23";

//  object prototype

XMLObjTree.prototype.xmlDecl = '<?xml version="1.0" encoding="UTF-8" ?>\n';
XMLObjTree.prototype.attr_prefix = '-';

//  method: parseXML( xmlsource )

XMLObjTree.prototype.parseXML = function ( xml ) {
   var root;
   if ( window.DOMParser ) {
...
XMLObjTree.prototype.parseHTTP = function ( url, options, callback ) {
   var myopt = {};
...
XMLObjTree.prototype.parseDOM = function ( root ) {
   if ( ! root ) return;
...
XMLObjTree.prototype.parseElement = function ( elem ) {
   //  COMMENT_NODE
   if ( elem.nodeType == 7 ) {
       return;
   }
...
XMLObjTree.prototype.addNode = function ( hash, key, cnts, val ) {
...
XMLObjTree.prototype.writeXML = function ( tree ) {
...
XMLObjTree.prototype.hash_to_xml = function ( name, tree ) {
   var elem = [];
   var attr = [];
   for( var key in tree ) {
...
XMLObjTree.prototype.array_to_xml = function ( name, array ) {
   var out = [];
...
XMLObjTree.prototype.scalar_to_xml = function ( name, text ) {
   if ( name == "#text" ) {
...
XMLObjTree.prototype.xml_escape = function ( text ) {
...
XMLObjTree class is a parser/generater between XML source code
...
=head2 xotree = new XMLObjTree()

This constructor method returns a new XMLObjTree object.
